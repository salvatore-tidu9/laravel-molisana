...
Route::get('/news', function () {
    $notizia = [
        [
            'titolo' => 'Tenacità certificata',

            'paragrafo' => 'La Molisana ha deciso di dare una connotazione scientifica al termine “tenacità” ottenendo la certificazione da parte di DNVGL, uno dei principali enti internazionali.

            “La nostra pasta è ufficialmente tenace, compatta in tutte le sue parti, elastica in masticazione e capace di mantenere intatte forma e consistenza anche sotto stress. Virtù che abbiamo deciso di attestare attraverso DNVGL – afferma Daniela Pietrunti, responsabile Controllo e Qualità La Molisana – Si tratta di un percorso avviato due anni fa che ha coinvolto tutte le figure cruciali della filiera produttiva con l’obiettivo di standardizzare i processi e garantire non solo gli elevati target qualitativi prefissati ma anche lo spirito tenace che caratterizza il nostro temperamento e la nostra pasta”.
            
            Informazione importante a tutela del consumatore che è diventata oggetto di una rubrica social all’interno del piano editoriale dell’azienda, di una sezione dedicata del sito web e di un bollino visibile sul pack delle otto referenze certificate.'
        ],
        [
            'titolo' => 'Prosegue l’attivita formativa di primo soccorso, in sala macchine simulazione di folgorazione',

            'paragrafo' => 'Si è svolta nei giorni scorsi la prima prova di emergenza nella sala macchine del pastificio.
        ...
        [
            'titolo' => 'Industria Felix Magazine, La Molisana tra le aziende premiate per performance gestionale e affidabilità finanziaria',

            'paragrafo' => 'In modalità online si è svolta la sesta edizione per la Puglia e la seconda per la Basilicata ed il Molise del Premio Industria Felix.

            I lavori sono stati aperti dal direttore responsabile del magazine, Michele Montemurro, a cui sono seguiti gli interventi istituzionali dei presidenti di Confindustria di Puglia e Molise, Sergio Fontana e Vincenzo Longobardo nonché dei referenti di banca Mediolanum e di amministratori regionali tra cui Vincenzo Cotugno vice presidente della Regione Molise. La Molisana per il secondo anno consecutivo ha ricevuto il premio, virtualmente ritirato dall’amministratore delegato Giuseppe Ferro. Sono state 52 in tutto le aziende premiate per ambiti diversi, dalla chimica alla farmaceutica, dall’ambiente ai metalli alla pasta. I dati sono stati rilevati da un’inchiesta di Industria Felix Magazine, il trimestrale diretto da Michele Montemurro realizzata con l’Ufficio studi di Cerved su circa 14mila bilanci. L’evento è stato realizzato in collaborazione con l’università Luiss, Regione Puglia, Puglia Sviluppo, A.C. Industria Felix con il patrocinio di Confindustria Molise, Puglia e Basilicata, Politecnico di Bari, Università di Bari, di Foggia, del Salento, con la partnership di Ansa, il Sole 24 Ore, Banca Mediolanum, Grant Thornton, Lidl Italia, Sustainable Development, FundCredit, Studio legale Iacobbi.'
        ],
    ];
